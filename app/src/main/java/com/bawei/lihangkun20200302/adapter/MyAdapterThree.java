...
public class MyAdapterThree extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<BeanClass.DataBean.GridDataBean> gridData;

    public MyAdapterThree(Context context, List<BeanClass.DataBean.GridDataBean> gridData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = View.inflate(context, R.layout.itwmthree, null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        String imageurl = gridData.get(i).getImageurl();
        String price = gridData.get(i).getPrice();
        String title = gridData.get(i).getTitle();
        ...
        ((ViewHolderOne)viewHolder).linthree.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class ViewHolderOne extends RecyclerView.ViewHolder{
        ...
        private final LinearLayout linthree;
        ...
        public ViewHolderOne(@NonNull View itemView) {
            ...
            linthree = itemView.findViewById(R.id.linthree);
        }
    }
